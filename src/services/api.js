...
// Use VITE_API_URL, fallback to local backend for development, and Render for production
export const API_BASE_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://army-smp-2.onrender.com/api');
